package com.app.encureitsystemsprivatelimitedtask.Preference;
...
public class UserSharedpreference {
    private static com.app.encureitsystemsprivatelimitedtask.Preference.UserSharedpreference userSharedpreference;
    private SharedPreferences sharedPreferences;

    public static com.app.encureitsystemsprivatelimitedtask.Preference.UserSharedpreference getInstance(Context context) {
        if (userSharedpreference == null) {
            userSharedpreference = new com.app.encureitsystemsprivatelimitedtask.Preference.UserSharedpreference(context);
        }
